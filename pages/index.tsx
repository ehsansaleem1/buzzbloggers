...
const Home: NextPage = () => {
  ...
  async function loginfunc(e:any) {
    e.preventDefault()
  ...
  return (
    <div>
      <div className={styles.container}>
        <Head>
          <title>Buzzbloggers - Login</title>
        ...
        <div className={styles.flexC}>
          ...
          <div className={styles.btnSide}>
            ...
            <h2>
              Use Gmail account to signin to Buzzbloggers and continue having
              fun :))
            </h2>
